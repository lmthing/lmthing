...
`sdk/org/scenarios/06-tanzania`; the harness at `sdk/org/scenarios/harness/`.

## The mission

Extend `06-tanzania` with **additional Acts**, run the **whole scenario end-to-end against LIVE
...
1. **Provision + smoke.** `cd sdk/org/scenarios/harness && node provision.mjs 06-tanzania`

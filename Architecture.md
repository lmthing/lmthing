...
|-----------|------|-------|------|
| `sdk/org/libs/core/` | @lmthing/core | TypeScript, QuickJS WASM, Zod | Runtime — QuickJS sandbox, eval loop, globals, system spaces (system-global, system-engineer, system-architect, system-research, user-memory, user-thing) |

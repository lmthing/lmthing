...
| `Input` interface/type | Request contract — generated to a JSON Schema (empty-object schema when absent) `sdk/org/libs/cli/src/app/build/schema.ts:52,159-198`. |
| `Output` type/interface | Response contract — generated to a JSON Schema (empty-object schema when absent) `sdk/org/libs/cli/src/app/build/schema.ts:54,159-198`. |
| default `handler(input, ctx)` | The async function returning `Output`; loaded as the module's default export `sdk/org/libs/cli/src/app/api/handler-module.ts:67-79`. |

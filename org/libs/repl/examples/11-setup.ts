 ...
 * sees the declared checkpoints and variables as if it wrote them itself.
 *
 * Run:
...
export default function ({ checkpoints }: { checkpoints: Function }) {
...
export const replConfig = {
  keepHistory: true,
  instruct: `You are an inventory assistant. A checkpoint plan has already been set up for you — follow it. Add 3 items (e.g. apples, bananas, oranges) with varying quantities, then summarize.`,
};

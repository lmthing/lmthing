...
|---|---|---|
| `user-thing` / `thing` | `store:read`, `store:install` | `sdk/org/libs/core/system-spaces/user-thing/agents/thing/instruct.md:15-16` |

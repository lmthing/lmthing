...
`sdk/org/scenarios/07-life-admin`; the harness at `sdk/org/scenarios/harness/`.

## The mission

Extend `07-life-admin` with **additional Acts**, run the **whole scenario end-to-end against LIVE
...
1. **Provision + smoke.** `cd sdk/org/scenarios/harness && node provision.mjs 07-life-admin`

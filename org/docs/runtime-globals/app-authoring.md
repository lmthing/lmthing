...
Same signatures and the same slug/route/method/schema validation, but they write **into the project the session is running in** and then apply the change `sdk/org/libs/cli/src/app/authoring/globals.ts:332-514`:

...
- `sdk/org/scenarios/07-life-admin/scenario.md` has all six sections + the feature checklist + the Acts table, now **including the
  new Acts** you added this round.
- `sdk/org/scenarios/07-life-admin/run.mjs` reproduces the literal user flow and its Acts match the `.md` table **1:1**, keeping

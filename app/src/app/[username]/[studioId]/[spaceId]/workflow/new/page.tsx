...
/**
 * Create new workflow page - renders the workflow editor in create mode.
 */
export default function NewWorkflowPage() {
  return (
    <div style={{ padding: '2rem', maxWidth: '64rem', margin: '0 auto' }}>
      <Heading level={2}>New Workflow</Heading>
      <Caption muted style={{ marginBottom: '2rem' }}>Create a new workflow by defining its steps and configuration.</Caption>
        ...
        <div className="panel__body">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
              ...
              <input className="input" placeholder="What does this workflow do?" />
            </div>
          </div>
        </div>
      </div>

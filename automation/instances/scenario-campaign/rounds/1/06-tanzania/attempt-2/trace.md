...
- delegates: system-files/dispatch, system-vision/vision, system-files/sheet, system-files/reader, system-files/sheet, system-files/reader
- yields: delegate, loadKnowledge, readDocument, inspect
- errors: typecheck_error@1
- reply: {"type":"Stack","props":{"gap":2},"children":[{"type":"Heading","props":{"level":2},"children":["Here's what I can see so far"]},{"type":"Paragraph","props":{},"children":["From your voice memo (crater day): driver guide ",{"type":"Strong",
- spaces: (none)
...
- reply: {"type":"Stack","props":{"gap":2},"children":[{"type":"Callout","props":{"variant":"success","title":"Done — your Tanzania trip is organized and ready"},"children":["Everything is live in your project. Open ",{"type":"Link","props":{"href":
- spaces: Ngorongoro Safari Advisor, Safari Logistics & Trip Coordination, Zanzibar Stone Town Advisor
- app tables: action_items(6), contacts(6), costs(9), legs(8), notes(5), park_fees(9), photos(1)

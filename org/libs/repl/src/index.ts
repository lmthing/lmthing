...
export type { GlobalsConfig, ContextBudgetSnapshot, ReflectRequest, ReflectResult, SpeculateBranch, SpeculateBranchResult, SpeculateResult, CompressOptions, ForkRequest, ForkResult, TraceSnapshot, CheckpointData } from './sandbox/globals'

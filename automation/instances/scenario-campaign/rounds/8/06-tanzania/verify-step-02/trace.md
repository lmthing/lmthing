...
- yields: loadKnowledge, inspect, setSessionMeta, delegate, readDocument
- reply: {"type":"Stack","props":{"gap":2},"children":[{"type":"Heading","props":{"level":2},"children":["Ok, I've read everything you sent. Here's what you're carrying:"]},{"type":"Callout","props":{"variant":"info","title":"What you handed me"},"c
- spaces: (none)
...
## Step 2 — say
- spaces: Ngorongoro Advisor, Tanzania Trip Advisor, Tanzania Trip Budget, Zanzibar Advisor, Zanzibar Trip Advisor
- app tables: accommodations(8)

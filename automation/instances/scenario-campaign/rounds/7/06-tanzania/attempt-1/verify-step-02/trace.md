...
- reply: {"type":"Stack","props":{"gap":2},"children":[{"type":"Heading","props":{"level":2},"children":["Documents Summary"]},{"type":"Callout","props":{"variant":"info","title":"Reader Specialist Response (Markdown + PDF)"},"children":["SUMMARY OF
- spaces: (none)
...
**sent:** Yes please.
- delegates: user-memory/memory
- yields: delegate, loadKnowledge, inspect
- reply: {"type":"Stack","props":{"gap":2},"children":[{"type":"Heading","props":{"level":2},"children":["Welcome to your Tanzania trip project!"]},{"type":"Paragraph","props":{},"children":["It looks like I don't have any record of a previous offer
- spaces: (none)

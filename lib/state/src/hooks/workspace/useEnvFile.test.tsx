...
describe('useEnvFile', () => {
  ...
  it('should parse env file', () => {
    const env = 'KEY=value\nDEBUG=true\nCOUNT=42'
    appFS.writeFile('alice/test/space1/.env', env)
  ...
  it('should handle named env files', () => {
    appFS.writeFile('alice/test/space1/.env.production', 'API_KEY=prod-key')
  ...
  it('should handle encrypted env files as error', () => {
    const encrypted = '-----BEGIN XOR ENCRYPTED ENV-----\nencrypted-content\n-----END XOR ENCRYPTED ENV-----'
    appFS.writeFile('alice/test/space1/.env', encrypted)
  ...
  it('should re-render when env file is updated', async () => {
    appFS.writeFile('alice/test/space1/.env', 'KEY=original')
    ...
    appFS.writeFile('alice/test/space1/.env', 'KEY=updated')
  ...
  it('should re-render when env file is created', async () => {
    ...
    appFS.writeFile('alice/test/space1/.env', 'NEW=value')
  ...
  it('should not re-render when different env file changes', async () => {
    ...
    appFS.writeFile('alice/test/space1/.env', 'KEY1=value1')
    appFS.writeFile('alice/test/space1/.env.local', 'KEY2=value2')
    ...
    appFS.writeFile('alice/test/space1/.env.local', 'KEY2=updated')

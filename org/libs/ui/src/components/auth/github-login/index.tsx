      ...
      {deviceCodePrompt ? (
        <Card>
          <CardBody>
            ...
            <Caption style={{ marginTop: '0.5rem' }}>And enter code:</Caption>
            <Code block style={{ textAlign: 'center', letterSpacing: '0.2em', fontSize: '1.5rem' }}>
              {deviceCodePrompt.userCode}
            </Code>
            <Caption muted style={{ marginTop: '0.75rem' }}>Waiting for authorization...</Caption>
          </CardBody>
        </Card>
      ) : (

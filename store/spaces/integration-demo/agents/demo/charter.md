...
(`INTEGRATION_DEMO_BASE_URL`, e.g. a webhook.site URL) through provided wrapper functions — you never see or
handle the raw token; the pod attaches the user's own `INTEGRATION_DEMO_API_TOKEN` (configured in the project's

...
5. **`⚠ [system] Tasklist incomplete. ...`** — your stream ended before all tasks were completed. Continue working on the next incomplete task. Do not re-declare `tasklist` or redo completed work.

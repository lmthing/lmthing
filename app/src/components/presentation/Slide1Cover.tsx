...
export default function Slide1Cover() {
  return (
    ...
    >
      {/* Hackathon badge */}
      <span
        className="mb-10 rounded-full border px-5 py-1.5 text-sm font-semibold tracking-wide"
      ...
      {/* Headline */}
      <h1 className="text-center text-6xl font-bold leading-tight tracking-tight sm:text-7xl" style={{ color: colors.white }}>
      ...
      {/* Subtitle */}
      <p className="mt-6 text-center text-xl" style={{ color: colors.muted }}>
      ...
      <div className="mt-16 flex items-center gap-2 text-lg">
        <span className="font-bold" style={{ color: colors.teal }}>Matilda</span>

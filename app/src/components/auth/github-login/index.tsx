  ...
  if (isAuthenticated && user) {
    return (
      <div className="stack stack--row stack--gap-sm" style={{ alignItems: 'center' }}>
        <img src={user.avatar_url} alt={user.login} className="avatar avatar--sm" />
      ...
      {deviceCodePrompt ? (
        <div className="card">
          <div className="card__body">
            <p className="caption">Please go to:</p>
            <a
            ...
            <p className="caption" style={{ marginTop: '0.5rem' }}>And enter code:</p>
            <div className="code-block" style={{ textAlign: 'center', letterSpacing: '0.2em', fontSize: '1.5rem' }}>
              {deviceCodePrompt.userCode}
            </div>
            <p className="caption caption--muted" style={{ marginTop: '0.75rem' }}>

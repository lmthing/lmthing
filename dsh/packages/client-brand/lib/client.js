  ...
  factory: (require) => {
    ...
    function injectFavicon() {
      ...
      if (existing.length > 0) {
        existing.forEach((link2) => {
          link2.type = "image/png";
          link2.href = FAVICON_DATA_URI;
        });
        return;
      }

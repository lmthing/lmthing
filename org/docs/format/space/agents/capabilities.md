...
| Agent | `capabilities:` |
|---|---|
| `user-thing/thing` | `project:manage`, `db:read`, `db:write`, `store:read`, `store:install`, `api:call` (`sdk/org/libs/core/system-spaces/user-thing/agents/thing/instruct.md:11-31`) |

# Scenario campaign — `05-latam` · round 3 (ADD ACTS (batch 3))
...
1. **Orient & resume.** Read `sdk/org/scenarios/05-latam/scenario.md` (esp. its Acts table + Actual-results), `sdk/org/scenarios/05-latam/run.mjs`,
   ...
   and any open frontier a prior round recorded. Read this run's `/home/vasilis/LMTHING/lmthing/automation/instances/scenario-campaign/rounds/3/05-latam/PROGRESS.md` if it exists.
...
- **Scenario:** `05-latam` (`sdk/org/scenarios/05-latam`)  ·  **Round:** 3 — ADD ACTS (batch 3)  ·  **Branch:** `main`
...
Maintain the per-run progress log at **/home/vasilis/LMTHING/lmthing/automation/instances/scenario-campaign/rounds/3/05-latam/PROGRESS.md**.

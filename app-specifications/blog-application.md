...
> A concrete instantiation of [the project-as-application model](../org/docs/format/project/README.md) for
...
8. **Docs** — fold into `org/docs/format/project/` as the worked example.
...
- **Reuses the parent engine wholesale** — no blog-specific runtime; this is data + agents + pages +
  ...
  [the project-as-application model](../org/docs/format/project/README.md), not a blog fork.
